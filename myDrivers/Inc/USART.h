...
#define USART_WORD_LENGTH_8Bits		( (uint32_t)(0x00000000))
#define USART_WORD_LENGTH_9Bits		( (uint32_t)(0x00001000))
...
#define __USART_DIV_VALUE_16(__CLOCK__, __BAUDRATE__)   ( (25 * (__CLOCK__) ) / (4 * (__BAUDRATE__) ) )
#define __USART_DIV_VALUE_8(__CLOCK__, __BAUDRATE__)    ( (25 * (__CLOCK__) ) / (2 * (__BAUDRATE__) ) )
