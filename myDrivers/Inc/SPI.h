...
#define SPI_DS_4BIT                  ((uint32_t)0x00000300)  // 0011
#define SPI_DS_5BIT                  ((uint32_t)0x00000400)  // 0100
#define SPI_DS_6BIT                  ((uint32_t)0x00000500)  // 0101
#define SPI_DS_7BIT                  ((uint32_t)0x00000600)  // 0110
#define SPI_DS_8BIT                  ((uint32_t)0x00000700)  // 0111
#define SPI_DS_9BIT                  ((uint32_t)0x00000800)  // 1000
#define SPI_DS_10BIT                 ((uint32_t)0x00000900)  // 1001
#define SPI_DS_11BIT                 ((uint32_t)0x00000A00)  // 1010
#define SPI_DS_12BIT                 ((uint32_t)0x00000B00)  // 1011
#define SPI_DS_13BIT                 ((uint32_t)0x00000C00)  // 1100
#define SPI_DS_14BIT                 ((uint32_t)0x00000D00)  // 1101
#define SPI_DS_15BIT                 ((uint32_t)0x00000E00)  // 1110
#define SPI_DS_16BIT                 ((uint32_t)0x00000F00)  // 1111
...
typedef struct
{
	...
	uint32_t DataSize;		/*!> DataSize Values for SPI @def_group SPI_DataSize		*/
